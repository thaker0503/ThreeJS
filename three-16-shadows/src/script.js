...
// pointLight.shadow.camera.fov = 30 //Cannot Use fov in this as it generates 6 different cameras
...
shadowSphere.rotation.x = - Math.PI * 0.5
...
// renderer.shadowMap.type = THREE.PCFShadowMap   //Default type
...
const tick = () => {
    ...
    // Updating Shadow
    shadowSphere.position.x = sphere.position.x 
    shadowSphere.position.z = sphere.position.z 
    shadowSphere.material.opacity = (1 - sphere.position.y) * 0.5 
